...
<?php
      ...
      //maka dapatkan id dari link
      
			$judul 		= $_GET['judul_post'];

			$isi 		= $_POST['isi_post'];

			
			$query 	= "UPDATE tbl_post SET judul_post = '$judul', isi_post = '$isi' WHERE tbl_post.judul_post = '$judul' ";
			//eksekusi update data
			$update = mysqli_query($dbcon, $query);
			//setelah data berhasil di update redirect ke halaman index
    }
